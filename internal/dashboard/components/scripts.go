...
// points somewhere other than the default components directory. tinyroute's
// components live under internal/dashboard/components (components.json alias),
// so the path is pinned here.
const developmentComponentsDir = "internal/dashboard/components"
